// ======================================================================
// \title  ImuDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef IMUDEPLOYMENT_IMUDEPLOYMENTTOPOLOGY_HPP
#define IMUDEPLOYMENT_IMUDEPLOYMENTTOPOLOGY_HPP
// Included for access to ImuDeployment::TopologyState and ImuDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ImuDeployment/Top/ImuDeploymentTopologyDefs.hpp>
 ...
 * ImuDeployment::TopologyState see: ImuDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ImuDeployment::TopologyState see: ImuDeploymentTopologyDefs.hpp.
 *
...
/**
 * \brief cycle the rate group driver using the base clock interval defined next to the divisors
 *
 * Blocks until stopRateGroups() is called.
 */
