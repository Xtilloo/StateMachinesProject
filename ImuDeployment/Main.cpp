...
#include <ImuDeployment/Top/ImuDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    ImuDeployment::TopologyState inputs;
    ...
    ImuDeployment::setupTopology(inputs);
    ImuDeployment::startRateGroups();
    ImuDeployment::teardownTopology(inputs);
